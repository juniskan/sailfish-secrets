...
class CryptoDBusObject : public QObject, protected QDBusContext
{
    ...
    "          <arg name=\"keyTemplate\" type=\"((ss)iiiiiiiayayayiiaay(a{sv}))\" direction=\"in\" />\n"
    "          <arg name=\"cryptosystemProviderName\" type=\"s\" direction=\"in\" />\n"
    "          <arg name=\"result\" type=\"(iiis)\" direction=\"out\" />\n"
    "          <arg name=\"key\" type=\"((ss)iiiiiiiayayayiiaay(a{sv}))\" direction=\"out\" />\n"
    ...
    "          <arg name=\"key\" type=\"((ss)iiiiiiiayayayiiaay(a{sv}))\" direction=\"in\" />\n"
